...
> **Superseded runtime report.** This is a historical diagnostic from 21 July 2026. It contains
> stale Docker, Stripe, fallback-Tira, unverified-SOS, and migration claims. Do not treat it as a
> deployment or launch checklist. Read
> [`docs/VERIFIED_TAKEOVER_STATE.md`](docs/VERIFIED_TAKEOVER_STATE.md) for verified state as of
> 4 August 2026.
