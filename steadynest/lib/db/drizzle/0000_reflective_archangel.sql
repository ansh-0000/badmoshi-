-- The geo_idx migration below uses PostGIS geography. This must be the first
-- statement in the initial schema so an empty portable Postgres database can
-- migrate without a manual extension-install step.
