...
export const CHAT_ROOMS: ChatRoom[] = [
  { id: 'delhi', city: 'Delhi', name: 'Delhi Nomads', activeUsers: 47, lastMessage: 'Anyone know a good SIM card shop near CP?', lastTime: '2m', emoji: '🏛' },
  { id: 'goa', city: 'Goa', name: 'Goa Chill Zone', activeUsers: 89, lastMessage: 'Sunset at Vagator tonight at 6:30 — worth it', lastTime: '5m', emoji: '🌊' },
  { id: 'mumbai', city: 'Mumbai', name: 'Mumbai Hustlers', activeUsers: 134, lastMessage: 'Co-working space rec in Lower Parel?', lastTime: '12m', emoji: '🏙' },
  { id: 'bengaluru', city: 'Bengaluru', name: 'BLR Tech Nomads', activeUsers: 201, lastMessage: 'Indiranagar coffee scene hits different', lastTime: '18m', emoji: '☕️' },
  { id: 'jaipur', city: 'Jaipur', name: 'Jaipur Explorers', activeUsers: 31, lastMessage: 'Amber Fort opens at 8am — go early', lastTime: '35m', emoji: '🏯' },
  { id: 'manali', city: 'Manali', name: 'Manali Mountains', activeUsers: 22, lastMessage: 'Road to Spiti is open, conditions good', lastTime: '1h', emoji: '⛰' },
];
...
export const INITIAL_MESSAGES: Record<string, Message[]> = {
  delhi: [
    { id: '1', sender: 'Arjun M.', text: 'Just landed — customs was fast today', timestamp: '10:12', isOwn: false },
    { id: '2', sender: 'Kavya R.', text: 'Welcome! Head to Terminal 3 exit for the prepaid auto', timestamp: '10:14', isOwn: false },
    { id: '3', sender: 'You', text: 'Thanks — is Airtel or Jio better for data here?', timestamp: '10:18', isOwn: true },
    { id: '4', sender: 'Arjun M.', text: 'Jio for Delhi NCR — unlimited 84-day plan is 💯', timestamp: '10:19', isOwn: false },
    { id: '5', sender: 'Preet S.', text: 'Anyone know a good SIM card shop near CP?', timestamp: '11:02', isOwn: false },
  ],
  goa: [
    { id: '1', sender: 'Luna V.', text: 'Arambol shacks have set up for the season finally', timestamp: '09:00', isOwn: false },
    { id: '2', sender: 'Marco T.', text: 'Sunset at Vagator tonight at 6:30 — worth it', timestamp: '15:30', isOwn: false },
    { id: '3', sender: 'You', text: 'Is the Vagator beach road still open?', timestamp: '15:45', isOwn: true },
    { id: '4', sender: 'Luna V.', text: 'Yes fully open, park near the chai stall', timestamp: '15:47', isOwn: false },
  ],
};
