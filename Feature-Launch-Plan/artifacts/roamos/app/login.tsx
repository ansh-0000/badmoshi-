      ...
      >
        <View style={styles.logoRow}>
          <View style={styles.logoCircle}>
            <Feather name="compass" size={32} color={primaryColor} />
          </View>
        </View>
        <Text style={styles.logoText}>ROAM•OS</Text>
        <Text style={styles.tagline}>
          {isTenant ? 'Find your perfect stay across India' : 'Manage your properties with ease'}
        </Text>
      </LinearGradient>
