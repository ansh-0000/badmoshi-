-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 4.0.0 to 4.0.1
...
CREATE OR REPLACE FUNCTION _pgr_dijkstra_v4(
    TEXT, -- edges
...
CREATE OR REPLACE FUNCTION _pgr_ksp_v4(
  TEXT,     -- edges
  ANYARRAY, -- start_vids
  ANYARRAY, -- end_vids
  INTEGER,  -- k
...
CREATE OR REPLACE FUNCTION _pgr_withPointsKSP_v4(
  TEXT, -- edges
  TEXT, -- points
  ANYARRAY, -- departures
...
CREATE OR REPLACE FUNCTION _pgr_turnRestrictedPath_v4(
  TEXT,   -- edges_sql
...
CREATE OR REPLACE FUNCTION _pgr_TSP_v4(
  TEXT,
  BIGINT,
  BIGINT,
...
CREATE OR REPLACE FUNCTION _pgr_TSPeuclidean_v4(
  TEXT,
  BIGINT,
  BIGINT,
...
CREATE OR REPLACE FUNCTION _pgr_trsp_withPoints_v4(
    TEXT,  -- edges_sql
    TEXT,  -- restrictions_sql
    TEXT,  -- points_sql
    ANYARRAY,  -- start_vid
...
CREATE OR REPLACE FUNCTION _pgr_trspVia_withPoints_v4(
  TEXT,     -- edges
  TEXT,     -- restrictions
  TEXT,     -- points
  ANYARRAY, -- via
...
CREATE OR REPLACE FUNCTION _pgr_maxCardinalityMatch_v4(
    edges_sql TEXT,
    OUT edge BIGINT)
...
CREATE OR REPLACE FUNCTION _pgr_withPoints_v4(
    TEXT, -- edges
    TEXT, -- points
...
CREATE OR REPLACE FUNCTION _pgr_withPointsVia_v4(
  TEXT,     -- edges_sql
  TEXT,     -- points_sql
  ANYARRAY, -- via vids
  BOOLEAN,  -- directed
...
CREATE OR REPLACE FUNCTION _pgr_dagShortestPath_v4(
    TEXT, -- edges
...
CREATE OR REPLACE FUNCTION _pgr_sloanOrdering(
    TEXT,
    OUT seq BIGINT,
    OUT node BIGINT
    )
...
CREATE OR REPLACE FUNCTION pgr_sloanOrdering(
    TEXT, -- edges_sql (required)
    OUT seq BIGINT,
    OUT node BIGINT)
RETURNS SETOF RECORD AS
...
CREATE OR REPLACE FUNCTION _pgr_kingOrdering(
    TEXT,
    OUT seq BIGINT,
    OUT node BIGINT
    )
...
CREATE OR REPLACE FUNCTION pgr_kingOrdering(
    TEXT, -- edges_sql (required)
    OUT seq BIGINT,
    OUT node BIGINT)
RETURNS SETOF RECORD AS
...
-- _pgr_bandwidth
--------------------------------
CREATE OR REPLACE FUNCTION _pgr_bandwidth(
    TEXT,
...
CREATE OR REPLACE FUNCTION pgr_bandwidth(
    TEXT,    -- edges_sql (required)
