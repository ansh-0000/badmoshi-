-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
-- pgRouting extension upgrade from 3.8.0 to 4.0.1
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_ksp(text,anyarray,anyarray,integer,boolean,boolean,boolean);
DROP FUNCTION IF EXISTS _pgr_ksp(text,anyarray,anyarray,integer,boolean,boolean,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_ksp(text,text,integer,boolean,boolean);
DROP FUNCTION IF EXISTS _pgr_ksp(text,text,integer,boolean,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_trsp_withpoints(text,text,text,anyarray,anyarray,boolean,character,boolean);
DROP FUNCTION IF EXISTS _pgr_trsp_withpoints(text,text,text,anyarray,anyarray,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_trsp_withpoints(text,text,text,text,boolean,character,boolean);
DROP FUNCTION IF EXISTS _pgr_trsp_withpoints(text,text,text,text,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_trspvia_withpoints(text,text,text,anyarray,boolean,boolean,boolean,character,boolean);
DROP FUNCTION IF EXISTS _pgr_trspvia_withpoints(text,text,text,anyarray,boolean,boolean,boolean,character,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_withpointsksp(text,text,anyarray,anyarray,integer,character,boolean,boolean,boolean,boolean);
DROP FUNCTION IF EXISTS _pgr_withpointsksp(text,text,anyarray,anyarray,integer,character,boolean,boolean,boolean,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_withpointsksp(text,text,text,integer,character,boolean,boolean,boolean);
DROP FUNCTION IF EXISTS _pgr_withpointsksp(text,text,text,integer,character,boolean,boolean,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION _pgr_withpointsvia(text,text,anyarray,boolean,boolean,boolean,character,boolean);
DROP FUNCTION IF EXISTS _pgr_withpointsvia(text,text,anyarray,boolean,boolean,boolean,character,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION _v4trsp(text,text,anyarray,anyarray,boolean);
DROP FUNCTION IF EXISTS _v4trsp(text,text,anyarray,anyarray,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION _v4trsp(text,text,text,boolean);
DROP FUNCTION IF EXISTS _v4trsp(text,text,text,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_findcloseedges(text,geometry,double precision,integer,boolean,boolean);
DROP FUNCTION IF EXISTS pgr_findcloseedges(text,geometry,double precision,integer,boolean,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_findcloseedges(text,geometry[],double precision,integer,boolean,boolean);
DROP FUNCTION IF EXISTS pgr_findcloseedges(text,geometry[],double precision,integer,boolean,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp_withpoints(text,text,text,anyarray,anyarray,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_trsp_withpoints(text,text,text,anyarray,anyarray,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp_withpoints(text,text,text,anyarray,bigint,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_trsp_withpoints(text,text,text,anyarray,bigint,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp_withpoints(text,text,text,bigint,anyarray,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_trsp_withpoints(text,text,text,bigint,anyarray,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp_withpoints(text,text,text,bigint,bigint,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_trsp_withpoints(text,text,text,bigint,bigint,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trsp_withpoints(text,text,text,text,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_trsp_withpoints(text,text,text,text,boolean,character,boolean);
ALTER EXTENSION pgrouting DROP FUNCTION pgr_trspvia_withpoints(text,text,text,anyarray,boolean,boolean,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_trspvia_withpoints(text,text,text,anyarray,boolean,boolean,boolean,character,boolean);
...
ALTER EXTENSION pgrouting DROP FUNCTION pgr_withpointsvia(text,text,anyarray,boolean,boolean,boolean,character,boolean);
DROP FUNCTION IF EXISTS pgr_withpointsvia(text,text,anyarray,boolean,boolean,boolean,character,boolean);
...
CREATE OR REPLACE FUNCTION pgr_contractionDeadEnd(
    TEXT,     -- edges_sql (required)
...
CREATE OR REPLACE FUNCTION pgr_contractionLinear(
    TEXT,     -- edges_sql (required)
...
CREATE OR REPLACE FUNCTION _pgr_primv4(
  TEXT,     -- Edge sql
...
CREATE OR REPLACE FUNCTION _pgr_kruskalv4(
  TEXT,     -- Edge sql
  ANYARRAY, -- tree root for traversal
  TEXT,     -- gn suffix
  BIGINT,   -- max depth
...
CREATE OR REPLACE FUNCTION _pgr_betweennessCentrality(
    edges_sql TEXT,
    directed BOOLEAN,
...
CREATE OR REPLACE FUNCTION pgr_betweennessCentrality(
    TEXT,    -- edges_sql (required)
    directed BOOLEAN DEFAULT true,
...
CREATE OR REPLACE FUNCTION pgr_separateCrossing(
  TEXT, -- edges SQL
...
CREATE OR REPLACE FUNCTION pgr_separateTouching(
  TEXT, -- edges SQL
  tolerance FLOAT DEFAULT 0.01, -- tolerance
  dryrun BOOLEAN DEFAULT false,
