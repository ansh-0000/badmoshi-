...
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
--
-- Generated on: 2026-02-10 06:37:03
...
CREATE OR REPLACE FUNCTION postgis_raster_scripts_installed() RETURNS text
       AS $$ SELECT trim('3.6.2'::text || $rev$ 3.6.2 $rev$) AS version $$
...
SELECT postgis_extension_drop_if_exists('postgis_raster', 'DROP FUNCTION _postgis_topology_upgrade_domain_type(text, text, text, text)');
DROP FUNCTION _postgis_topology_upgrade_domain_type(text, text, text, text);
SELECT postgis_extension_drop_if_exists('postgis_raster', 'DROP FUNCTION _postgis_drop_cast_by_types(text, text, text)');
DROP FUNCTION _postgis_drop_cast_by_types(text, text, text);
SELECT postgis_extension_drop_if_exists('postgis_raster', 'DROP FUNCTION _postgis_topology_upgrade_user_type_attribute(text, text, text, text, text)');
DROP FUNCTION _postgis_topology_upgrade_user_type_attribute(text, text, text, text, text);
SELECT postgis_extension_drop_if_exists('postgis_raster', 'DROP FUNCTION _postgis_add_column_to_table(regclass, name, text, boolean, text, text)');
